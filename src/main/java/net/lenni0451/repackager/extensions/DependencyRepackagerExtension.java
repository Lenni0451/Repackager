...
public abstract class DependencyRepackagerExtension implements RepackageSettings {
    ...
    public void register(final Configuration configuration, final Map<String, String> relocations, final boolean remapStrings, final boolean remapServices, final boolean remapManifest, final boolean removeEmptyDirs) {
        this.register(configuration, relocations, Collections.emptySet(), remapStrings, remapServices, remapManifest, removeEmptyDirs);
    }

    public void register(final Configuration configuration, final Map<String, String> relocations, final Set<String> removals, final boolean remapStrings, final boolean remapServices, final boolean remapManifest, final boolean removeEmptyDirs) {
        this.project.afterEvaluate(project -> {
            ...
            project.getDependencies().registerTransform(RepackageTransform.class, transform -> {
                ...
                transform.getParameters().getRemovals().set(removals);
